...
// Module under test
const LoanRenewed = rewire('../../src/loan-renewed/handler')

// Test data
const TestEvents = {
  LoanRenewed: require('./events/loan-renewed-event.json')
}
...
describe('loan updated lambda tests', () => {
  ...
  describe('SNS event tests', () => {
    it('should callback with a success message if the event is valid', (done) => {
      ...
      LoanRenewed.handle(TestEvents.LoanRenewed, null, (err, data) => {
        should.not.exist(err)
        data.should.equal('Loan 18263808770001221 successfully updated with event LOAN_RENEWED')
        done()
      })
    })
    ...
    it('should callback with an error if extractMessageData throws an error', (done) => {
      ...
      LoanRenewed.handle(testMessage, null, (err, data) => {
        should.not.exist(data)
        err.should.be.an.instanceOf(Error)
    ...
    it('should be rejected with an error if the event type is not LOAN_RENEWED', (done) => {
      const testEvent = {
        Records: [{
          Sns: {
      ...
      LoanRenewed.handle(testEvent, null, (err, data) => {
        should.not.exist(data)
  ...
  describe('update user method tests', () => {
    it('should call the getData method', () => {
      ...
      return LoanRenewed.__get__('updateUser')({ item_loan: { user_id: 'a user', loan_id: 'a loan' } })
        .then(() => {
  ...
  describe('update loan method tests', () => {
    it('should call the populate method with the correct parameters', () => {
      ...
      return LoanRenewed.__get__('updateLoan')({ item_loan: { loan_id: 'a loan', user_id: 'a user' } })
        .then(() => {
  ...
  describe('send user to Queue method tests', () => {
    ...
    it('should call Queue#getQueueUrl', () => {
      ...
      return LoanRenewed.__get__('sendUserToQueue')('').then(() => {
    ...
    it('should be rejected with an error if Queue#getQueueUrl is rejected', () => {
      ...
      return LoanRenewed.__get__('sendUserToQueue')('a user').should.eventually.be.rejectedWith('SQS broke')
        .and.should.eventually.be.an.instanceOf(Error)
    })
    ...
    it('should call Queue#sendMessage with the correct user ID', () => {
      ...
      return LoanRenewed.__get__('sendUserToQueue')('a user').then(() => {
    ...
    it('should be fulfilled if Queue#sendMessage is fulfilled', () => {
      ...
      return LoanRenewed.__get__('sendUserToQueue')('a user').should.eventually.be.fulfilled
    })
  })
  ...
  describe('extract message data tests', () => {
    it('should return parses JSON if the input is valid', () => {
      ...
      expect(() => LoanRenewed.__get__('extractMessageData')(testMessage)).to.not.throw()
      LoanRenewed.__get__('extractMessageData')(testMessage).should.deep.equal(expected)
    })
    ...
    it('should throw an error if the JSON is malformed', () => {
      ...
      expect(() => LoanRenewed.__get__('extractMessageData')(testMessage)).to.throw('Could not parse SNS message')
    })
  ...
  describe('end to end tests', () => {
    ...
    it('should call DynamoDB put correctly for the Users table', (done) => {
      ...
      LoanRenewed.handle(TestEvents.LoanRenewed, {}, (err, data) => {
        should.not.exist(err)
